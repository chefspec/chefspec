...
### Basic usage
ChefSpec lets you set node attributes as you'd expect:
...
### OHAI Attributes
If you have a cookbook that should support multiple platforms (for example RHEL and Ubuntu) you can set
[OHAI](http://wiki.opscode.com/display/chef/Ohai) attributes like so:

    chef_run.node.automatic_attrs[:platform] = 'PDP-11/20'
...
Check that a config file is generated correctly by a
[Template](http://wiki.opscode.com/display/chef/Resources#Resources-Template) resource in your cookbook.
